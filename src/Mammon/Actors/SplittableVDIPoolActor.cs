...
public class SplittableVDIPoolActor(ActorHost host, CostCentreRuleEngine costCentreRuleEngine, ILogger<SplittableVDIPoolActor> logger, IActorProxyFactory actorProxyFactory) : ActorBase<CoreResourceActorState>(host), ISplittableVDIPoolActor
{
