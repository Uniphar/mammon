...
public class SplitDevopsCostsActivity(ILogger<SplitDevopsCostsActivity> logger, IActorProxyFactory actorProxyFactory) : WorkflowActivity<DevopsResourceRequest, bool>
{
    public override async Task<bool> RunAsync(WorkflowActivityContext context, DevopsResourceRequest input)
    {
        ...
        try
        {
            await actorProxyFactory.CallActorWithNoTimeout<IDevOpsCostActor>(
