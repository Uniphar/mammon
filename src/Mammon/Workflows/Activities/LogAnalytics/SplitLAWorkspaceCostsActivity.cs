...
public class SplitLAWorkspaceCostsActivity(
    ILogger<SplitLAWorkspaceCostsActivity> logger,
    IActorProxyFactory actorProxyFactory) : WorkflowActivity<SplitUsageActivityRequest<LAWorkspaceQueryResponseItem>, bool>
{
    public override async Task<bool> RunAsync(WorkflowActivityContext context, SplitUsageActivityRequest<LAWorkspaceQueryResponseItem> input)
    {
        try
        {
            ...
            await actorProxyFactory.CallActorWithNoTimeout<ILAWorkspaceActor>(
