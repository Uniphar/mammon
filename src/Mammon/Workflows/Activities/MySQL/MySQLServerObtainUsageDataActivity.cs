...
public class MySQLServerObtainUsageDataActivity(MySQLService mySQLService) : WorkflowActivity<SplittableResourceRequest, (IEnumerable<MySQLUsageResponseItem> usageData, bool usageDataAvailable)>
{
