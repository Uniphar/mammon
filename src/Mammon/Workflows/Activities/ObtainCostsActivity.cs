...
public class ObtainCostsActivity(CostRetrievalService costService, CostCentreRuleEngine costCentreRuleEngine)
    : WorkflowActivity<ObtainCostsActivityRequest, ObtainCostByPageWorkflowResult>
{
