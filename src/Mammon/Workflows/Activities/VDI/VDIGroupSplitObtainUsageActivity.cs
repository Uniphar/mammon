...
public class VDIGroupSplitObtainUsageActivity(VDIService vdiService) : WorkflowActivity<SplittableResourceGroupRequest, (IEnumerable<VDIQueryUsageResponseItem> usageData, bool dataAvailable)>
{
