...
public class SplitVisualStudioSubscriptionsCostsActivity
    (ILogger<SplitVisualStudioSubscriptionsCostsActivity> logger, IActorProxyFactory actorProxyFactory) : WorkflowActivity<VisualStudioSubscriptionsSplittableResourceRequest, bool>
{
...

    {
        ...
        try
        {
            await actorProxyFactory.CallActorWithNoTimeout<IVisualStudioSubscriptionCostActor>(
